#!/bin/bash
# Bowtie2 WGS Mapping Batch Script: Batch 1
# Author: aubsxb005
# Description: Maps a batch of 3 WGS samples using Bowtie2

### -l select=1:ncpus=16:mpiprocs=16:mem=64000mb -l walltime=72:00:00
...
# --------- Run Batch 1 Samples ----------
map_sample "SRR21197535"
map_sample "SRR24030174"
map_sample "SRR24030175"

echo "[$(date)] Batch 1 mapping complete."
